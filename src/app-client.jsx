...
const ARTICLES = [
  {
    id:1, emoji:"🔬", category:"PCOS والهرمونات", time:"5 دقائق",
    title:"متلازمة تكيس المبايض والتغذية العلاجية — أحدث الأدلة",
    summary:"ماذا تقول أحدث الأبحاث العلمية لعام 2025 عن دور التغذية في علاج تكيس المبايض وتحقيق التوازن الهرموني؟",
    body:"استناداً إلى مراجعة منهجية شاملة نشرتها مجلة Frontiers in Nutrition عام 2025، والتي حلّلت ستةً وأربعين تجربةً عشوائيةً محكومةً شملت أكثر من ثلاثين ألف امرأة، ثبت أن التدخلات الغذائية تُحدث فارقاً حقيقياً وقابلاً للقياس في إدارة متلازمة تكيس المبايض.

أبرز النتائج العلمية:

أولاً — الإينوسيتول: يُحسّن حساسية الإنسولين بصورة ملموسة، ويُقلّل مستوى الأندروجينات الحرة في الدم.

ثانياً — البروبيوتيك: يُخفّض مؤشرات الالتهاب الجهازي كمستوى بروتين سي التفاعلي بشكل إحصائي دالّ.

ثالثاً — أحماض أوميغا 3 الدهنية: تُحسّن مستوى الدهون في الدم وتُقلّل الأندروجينات المرتبطة بأعراض التكيس.

رابعاً — نظام DASH الغذائي: يُحسّن التحكم في مستوى الجلوكوز ويدعم التوازن الهرموني العام.

الأطعمة الموصى بها:
• الشوفان والكينوا والبطاطا الحلوة لانخفاض مؤشرها الجلايسيمي
• السمك الدهني وبذور الكتان لغناهما بأوميغا 3
• البروكلي والكرنب لدعم عملية إزالة الاستروجين الزائد
• الزبادي الطبيعي كمصدر للبروبيوتيك",
    tips:["اختاري الكربوهيدرات المعقدة في كل وجبة","أضيفي مصدراً لأوميغا 3 يومياً","تناولي البروبيوتيك مع وجباتك الرئيسية","استبدلي القهوة المفلترة بالشاي الأخضر"],
  },
  {
    id:2, emoji:"🩸", category:"مقاومة الإنسولين", time:"4 دقائق",
    title:"مقاومة الإنسولين — الحل الغذائي الأمثل",
    summary:"نتائج إحدى وعشرين تجربةً عشوائيةً محكومةً تكشف أفضل الأنظمة الغذائية لعلاج مقاومة الإنسولين.",
    body:"وفقاً لمراجعة منهجية نشرتها مجلة Nutrients عام 2025، والتي استعرضت إحدى وعشرين تجربةً عشوائيةً محكومةً حتى نوفمبر 2024، ثمة أنماط غذائية متعددة ثبتت فعاليتها في إدارة مقاومة الإنسولين.

نظام DASH الغذائي:
أثبت هذا النظام تفوقه في خفض الوزن وتحسين التحكم بالجلوكوز. يرتكز على الخضروات والفواكه والحبوب الكاملة، مع تقليل الصوديوم وزيادة البوتاسيوم.

النظام الكيتوني:
أظهر تحسناً ملموساً في المؤشرات الجسدية والهرمونية، لا سيما في تحسين نسبة الهرمون اللوتيني إلى الهرمون المحفز للجريب. غير أنه يستلزم متابعةً متخصصةً لضمان الاستدامة.

المواد الغذائية التي يجب تجنبها:
• السكريات المكررة والعصائر الصناعية
• الدقيق الأبيض والأرز الأبيض والمعجنات
• الأطعمة المصنّعة والوجبات السريعة
• المشروبات الغازية حتى تلك الخالية من السكر",
    tips:["امشي عشر دقائق بعد كل وجبة رئيسية","ابدأي وجبتك بالخضروات ثم البروتين ثم الكربوهيدرات","لا تتناولي الكربوهيدرات منفردةً دون بروتين أو دهن صحي","اشربي كوباً من الماء قبل كل وجبة بعشرين دقيقة"],
  },
  {
    id:3, emoji:"🌙", category:"صحة الدورة الشهرية", time:"5 دقائق",
    title:"أوميغا 3 وآلام الدورة الشهرية — الدليل العلمي",
    summary:"تحليل تجميعي لاثنتي عشرة دراسةً علميةً يُثبت أن أوميغا 3 يُخفّض آلام الدورة الشهرية بصورة كبيرة.",
    body:"نشرت مجلة Nutrition & Dietetics عام 2024 تحليلاً تجميعياً شاملاً استعرض اثنتي عشرة دراسةً شملت ثمانياً وثمانين وثمانمائة امرأة، مُسلِّطاً الضوء على أثر أحماض أوميغا 3 الدهنية في تخفيف آلام الدورة الشهرية.

أبرز النتائج:
• تأثير إيجابي كبير في تقليل شدة الألم وفق مقياس كوهين
• الجرعة الفعّالة تتراوح بين ثلاثمائة وألف وثمانمائة ملليغرام يومياً لمدة شهرين إلى ثلاثة أشهر
• يُقلّل من الحاجة إلى مسكنات الألم تقليلاً ملحوظاً
• آمن ومتحمَّل جيداً دون آثار جانبية تُذكر

آلية عمل أوميغا 3:
تعمل أحماض أوميغا 3 على تثبيط إنتاج البروستاغلاندين المسبب الرئيسي لتشنجات الرحم، عبر إحداث تأثير مضاد للالتهاب. كما أثبتت دراسات مستقلة قدرتها على خفض الهرمون المحفز للجريب وتحسين التوازن الهرموني خلال الدورة.

أفضل المصادر الغذائية لأوميغا 3:
• السمك الدهني كالسلمون والسردين والماكريل
• بذور الكتان والشيا المطحونة
• الجوز والمكسرات الطازجة",
    tips:["تناولي السمك الدهني مرتين في الأسبوع على الأقل","أضيفي ملعقة كبيرة من بذور الكتان المطحونة لوجبة الفطور","ابدأي مكمّل أوميغا 3 قبل أسبوع من موعد الدورة","استشيري دكتورتك لتحديد الجرعة المثلى لحالتك"],
  },
  {
    id:4, emoji:"🥗", category:"التغذية الهرمونية", time:"4 دقائق",
    title:"أفضل الأطعمة لتوازن الهرمونات — بالدليل العلمي",
    summary:"استناداً إلى أحدث مراجعات المجلات العلمية المحكّمة، هذه الأطعمة ثبت علمياً أنها تدعم التوازن الهرموني.",
    body:"استناداً إلى أحدث مراجعات مجلتَي Nutrients وFrontiers in Nutrition للعامين 2024 و2025، تبرز الأطعمة التالية بوصفها الأكثر دعماً للتوازن الهرموني لدى المرأة:

البروكلي والكرنب:
يحتويان على مركّب الديندوليلميثان الذي يُساعد الكبد في إزالة الاستروجين الزائد وتحويله إلى صور أكثر أماناً.

ثمرة الأفوكادو:
مصدر غني بالدهون الأحادية غير المشبعة الضرورية لتصنيع الهرمونات الجنسية والحفاظ على سلامة أغشية الخلايا.

التوت الأزرق والأحمر:
يحتويان على مضادات أكسدة قوية تحمي البويضات من الضرر التأكسدي وتُقلّل الالتهاب الجهازي.

المكسرات والبذور:
مصادر طبيعية للزنك والسيلينيوم وأوميغا 3، وهي عناصر محورية لصحة الغدة الدرقية والمبايض على حدٍّ سواء.

زيت الزيتون البكر الممتاز:
يُقلّل الالتهاب ويُحسّن حساسية الإنسولين عبر آليات متعددة أثبتتها الدراسات السريرية.

الكركم والزنجبيل:
مضادا التهاب طبيعيان يُخفّفان أعراض تكيس المبايض وآلام الدورة الشهرية بفعالية موثّقة علمياً.",
    tips:["اجعلي كوب السبانخ أساس كل سلطة تتناولينها","استبدلي الزيوت النباتية المكررة بزيت الزيتون البكر الممتاز","أضيفي الكركم مع قليل من الفلفل الأسود لتعزيز امتصاصه","تناولي حفنةً من المكسرات الطازجة كوجبة خفيفة يومياً"],
  },
];
          ...
          <div style={{ ...card, textAlign:"center", padding:"32px 24px" }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
              {alreadyLogged && !submitted && (
                <button style={{ width:"100%", padding:"13px 0", borderRadius:12, background:C.blush, border:`1.5px solid ${C.pink}`, color:C.pink, cursor:"pointer", fontSize:14, fontWeight:800 }} onClick={()=>{ setAlreadyLogged(false); setStep(0); }}>✏️ تعديل تسجيل اليوم</button>
              )}
              {submitted && (
                <button style={{ width:"100%", padding:"13px 0", borderRadius:12, background:C.bg, border:`1.5px solid ${C.border}`, color:C.sub, cursor:"pointer", fontSize:13, fontWeight:700 }} onClick={()=>{ setSubmitted(false); setAlreadyLogged(false); setStep(0); }}>✏️ تعديل</button>
              )}
            </div>
          </div>
        </div>
...
function LibraryTab({ client }) {
  ...
  const items = [
    { id:1, type:"article", tag:"PCOS", icon:"🔬", title:"متلازمة تكيس المبايض والتغذية العلاجية", time:"5 دقائق",
      summary:"أحدث الأدلة العلمية لعام 2025 حول دور التغذية في إدارة تكيس المبايض وتحسين التوازن الهرموني.",
      body:"استناداً إلى مراجعة نشرتها مجلة Frontiers in Nutrition 2025، والتي حلّلت 46 تجربةً عشوائيةً شملت أكثر من 30,000 امرأة، ثبت أن التدخلات الغذائية تُحدث فارقاً حقيقياً في إدارة متلازمة تكيس المبايض.

أبرز النتائج:

أولاً — الإينوسيتول: يُحسّن حساسية الإنسولين ويُقلّل الأندروجينات الحرة.
ثانياً — البروبيوتيك: يُخفّض مؤشرات الالتهاب الجهازي بصورة دالّة إحصائياً.
ثالثاً — أوميغا 3: يُحسّن مستوى الدهون ويُقلّل الأندروجينات.
رابعاً — نظام DASH: يُحسّن ضبط الجلوكوز ويدعم التوازن الهرموني.

الأطعمة الموصى بها:
• الشوفان والكينوا والبطاطا الحلوة
• السمك الدهني وبذور الكتان
• البروكلي والكرنب لإزالة الاستروجين الزائد
• الزبادي الطبيعي كمصدر للبروبيوتيك",
      tips:["اختاري الكربوهيدرات المعقدة دائماً","أضيفي أوميغا 3 يومياً","تناولي البروبيوتيك مع وجباتك","استبدلي القهوة المفلترة بالشاي الأخضر"] },
    { id:2, type:"article", tag:"Insulin", icon:"🩸", title:"مقاومة الإنسولين — العلاج الغذائي الأمثل", time:"4 دقائق",
      summary:"نتائج 21 تجربةً عشوائيةً محكومةً تكشف أفضل الأنظمة الغذائية لمقاومة الإنسولين.",
      body:"وفقاً لمراجعة منهجية نشرتها مجلة Nutrients 2025 استعرضت 21 تجربةً عشوائيةً محكومةً، ثمة أنماط غذائية متعددة ثبتت فعاليتها في إدارة مقاومة الإنسولين.

نظام DASH الغذائي:
أثبت تفوقه في خفض الوزن وتحسين ضبط الجلوكوز. يرتكز على الخضروات والفواكه والحبوب الكاملة.

النظام الكيتوني:
أظهر تحسناً في المؤشرات الهرمونية، لا سيما نسبة LH/FSH. يستلزم متابعةً متخصصة.

ما يجب تجنبه:
• السكريات المكررة والعصائر الصناعية
• الدقيق والأرز الأبيض والمعجنات
• الأطعمة المصنّعة والوجبات السريعة",
      tips:["امشي عشر دقائق بعد كل وجبة","ابدأي وجبتك بالخضروات ثم البروتين","لا تتناولي الكربوهيدرات منفردةً","اشربي ماءً قبل الوجبة بعشرين دقيقة"] },
    { id:3, type:"article", tag:"Cycle", icon:"🌙", title:"أوميغا 3 وآلام الدورة الشهرية", time:"5 دقائق",
      summary:"تحليل تجميعي لاثنتي عشرة دراسةً يُثبت فعالية أوميغا 3 في تخفيف آلام الدورة.",
      body:"نشرت مجلة Nutrition & Dietetics 2024 تحليلاً تجميعياً استعرض 12 دراسةً شملت 881 امرأة حول أثر أوميغا 3 في آلام الدورة الشهرية.

أبرز النتائج:
• تأثير إيجابي كبير في تقليل شدة الألم
• الجرعة الفعّالة: 300-1800 ملغ يومياً لمدة 2-3 أشهر
• يُقلّل الحاجة إلى مسكنات الألم
• آمن ومتحمَّل جيداً

آلية العمل:
يثبّط أوميغا 3 إنتاج البروستاغلاندين المسبب لتشنجات الرحم عبر تأثيره المضاد للالتهاب.

أفضل المصادر الغذائية:
• السمك الدهني: سلمون، سردين، ماكريل
• بذور الكتان والشيا المطحونة
• الجوز الطازج",
      tips:["تناولي السمك الدهني مرتين أسبوعياً","أضيفي بذور الكتان المطحونة للفطور","ابدأي أوميغا 3 قبل أسبوع من الدورة","استشيري دكتورتك للجرعة المناسبة"] },
    { id:4, type:"article", tag:"Hormone", icon:"⚖️", title:"أفضل الأطعمة لتوازن الهرمونات", time:"4 دقائق",
      summary:"الأطعمة التي ثبت علمياً أنها تدعم التوازن الهرموني للمرأة.",
      body:"استناداً إلى مراجعات مجلتَي Nutrients وFrontiers in Nutrition 2024-2025:

البروكلي والكرنب:
يحتويان على مركّب الديندوليلميثان الذي يُساعد الكبد في إزالة الاستروجين الزائد.

الأفوكادو:
غني بالدهون الصحية الضرورية لتصنيع الهرمونات الجنسية.

التوت الأزرق والأحمر:
مضادات أكسدة تحمي البويضات وتُقلّل الالتهاب الجهازي.

المكسرات والبذور:
مصادر للزنك والسيلينيوم وأوميغا 3 لصحة الغدة الدرقية والمبايض.

زيت الزيتون البكر:
يُقلّل الالتهاب ويُحسّن حساسية الإنسولين.

الكركم والزنجبيل:
مضادا التهاب طبيعيان يُخففان أعراض تكيس المبايض وآلام الدورة.",
      tips:["اجعلي السبانخ أساس سلطتك اليومية","استبدلي الزيوت المكررة بزيت الزيتون البكر","أضيفي الكركم مع فلفل أسود لتعزيز امتصاصه","تناولي مكسرات طازجة كوجبة خفيفة يومياً"] },
    { id:5, type:"recipe", tag:"PCOS", icon:"🥗", title:"سلطة مكافحة الالتهاب", time:"3 دقائق",
      summary:"وصفة مضادة للالتهاب تدعم توازن هرمونات تكيس المبايض.",
      body:"المكونات:
• كوب سبانخ طازج
• نصف أفوكادو مقطّع
• ربع كوب جوز مكسّر
...
طريقة التحضير:
اخلطي جميع المكونات في وعاء كبير. أضيفي زيت الزيتون وعصير الليمون وتبّلي بالملح والفلفل. قدّميها فوراً للحفاظ على قيمتها الغذائية.",
      tips:["أضيفي ملعقة بذور كتان مطحونة لدعم إضافي","تناوليها على الغداء لأقصى فائدة","يمكن إضافة تونة أو بيض مسلوق للبروتين","أضيفي كركم وفلفل أسود كتوابل"] },
    { id:6, type:"recipe", tag:"Insulin", icon:"🥣", title:"وعاء الفطور المتوازن", time:"5 دقائق",
      summary:"فطور منخفض المؤشر الجلايسيمي يُثبّت السكر ويمنح طاقة مستدامة طوال اليوم.",
      body:"المكونات:
• نصف كوب شوفان مجروش
...
طريقة التحضير:
اطبخي الشوفان بحليب اللوز على نار هادئة مع التقليب المستمر. أضيفي بذور الشيا واتركي دقيقتين. أضيفي التوت وزبدة اللوز والقرفة وقدّميه دافئاً.",
      tips:["القرفة تُساعد في تنظيم مستوى السكر في الدم","لا تُضيفي أي سكر أو عسل إليه","يمكن تحضيره ليلاً وتناوله بارداً في الصباح","أضيفي بذور الكتان المطحونة لفائدة مضاعفة"] },
  ];
        ...
        <div style={{ display:"flex", gap:8, overflowX:"auto", marginBottom:16, paddingBottom:4 }}>
          {tags.map(t=>(
            <button key={t} onClick={()=>setFilter(t)} style={{ padding:"7px 14px", borderRadius:99, fontSize:12, fontWeight:700, cursor:"pointer", whiteSpace:"nowrap", background:filter===t?C.pink:C.bg, border:`1.5px solid ${filter===t?C.pink:C.border}`, color:filter===t?"white":C.sub, transition:"all .15s" }}>
              {t==="all"?"الكل 📚":t==="Insulin"?"إنسولين":t==="Cycle"?"الدورة":t==="Hormone"?"الهرمونات":t}
            </button>
          ))}
        </div>
        {/* Items */}
...
export default function App() {
  ...
  return (
    <div style={{ ...page, paddingBottom:0 }}>
      ...
      <MemberNav active={activeTab} onChange={setActiveTab}/>
    </div>
  );
}
